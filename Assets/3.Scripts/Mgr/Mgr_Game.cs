...
public class Mgr_Game : MonoBehaviour
{
    ...
    // 작업대 UI
    public void OpenCraftingStationUI(bool isOn, Interaction_CraftingStation inCraftingStationData = null)
    {
        SetGameplayMode(!isOn);

        Mgr_UI.Inst.CraftingStation(isOn, inCraftingStationData);
