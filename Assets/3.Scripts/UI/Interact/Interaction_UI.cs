...
public class Interaction_UI : MonoBehaviour
{
    ...
    public Interaction Interaction_Obj;
    ...
    public void UI_Update()
    {
        switch(InteractionType)
        {
            ...
            default:
                {
                    // 아이콘 설정
                    Item_Icon.sprite = Interaction_Obj.Interaction_Icon;

                    // 이름 설정
                    ItemName_Text.text = Interaction_Obj.Interaction_Name;
